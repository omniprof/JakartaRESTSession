 ...
 * the URL as in http://localhost:8080/Mod_05_RestServer/services/compound
 */
@Path("compound")
/**
...
public class CompoundInterestService {
     ...
     * http://localhost:8080/Mod_05_RestServer_presenter/services/compound?principal=100.00&annualInterestRate=0.05&compoundPerTimeUnit=12.0&time=5.0
     ...
     * "http://localhost:8080/Mod_05_RestServer/services/compound?principal=100.00&annualInterestRate=0.05&compoundPerTimeUnit=12.0&time=5.0"
     *
     * @param principal
