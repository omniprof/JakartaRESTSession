package com.eclipse.jsfclient.bean;
...
public class CompoundBean {
	...
	public CompoundBean(CompoundBean compoundBean) {
		this.principal = compoundBean.getPrincipal();
		this.annualInterestRate = compoundBean.getAnnualInterestRate();
		this.compoundPerTimeUnit = compoundBean.getCompoundPerTimeUnit();
		this.time = compoundBean.getTime();
		this.result = compoundBean.getResult();
	}
